...
public class NumbersActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    final static String TAG = NumbersActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordAdapter itemsAdapter = new WordAdapter(this, DataHandler.nummberArrayList, "Numbers");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        releaseMediaPlayer();
        mMediaPlayer = MediaPlayer.create(NumbersActivity.this, DataHandler.nummberArrayList.get(position).getSoundResourceID());
        mMediaPlayer.start();
        mMediaPlayer.setOnCompletionListener(this);

        DataHandler.addWord(this, 3, position);
