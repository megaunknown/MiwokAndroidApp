...
public class ColorsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    final static String TAG = ColorsActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordAdapter itemsAdapter = new WordAdapter(this, DataHandler.colorsArrayList, "Colors");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        mMediaPlayer = MediaPlayer.create(ColorsActivity.this, DataHandler.colorsArrayList.get(position).getSoundResourceID());
        mMediaPlayer.start();
        mMediaPlayer.setOnCompletionListener(this);

        DataHandler.addWord(this, 1, position);
