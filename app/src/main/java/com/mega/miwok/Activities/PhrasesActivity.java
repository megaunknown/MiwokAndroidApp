...
public class PhrasesActivity extends AppCompatActivity implements
        AdapterView.OnItemClickListener,
        MediaPlayer.OnCompletionListener,
        AudioManager.OnAudioFocusChangeListener {
    //for Debugging purpose
    final static String TAG = PhrasesActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordAdapter itemsAdapter = new WordAdapter(this, DataHandler.phraseArrayList, "Phrases");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            mMediaPlayer = MediaPlayer.create(PhrasesActivity.this, DataHandler.phraseArrayList.get(position).getSoundResourceID());
            mMediaPlayer.start();
            mMediaPlayer.setOnCompletionListener(this);

            DataHandler.addWord(this, 4, position);
